...
import { getOAuthProfile, isTokenExpired, saveOAuthProfile, type OAuthProfile } from "../io/oauthStore.js";
import { walkFiles } from "../io/fileWalker.js";
import { parseSource } from "../engines/analysis/ast.js";
import { runRuleEngine } from "../engines/analysis/rules.js";
import { runPatternDetectors } from "../engines/analysis/patterns.js";
import { runUniversalPatterns } from "../engines/analysis/universalPatterns.js";
import { runInfraPatterns } from "../engines/analysis/infraPatterns.js";
import { loadRules } from "../engines/rules/loadRules.js";
import { scanDependenciesWithCves } from "../engines/deps/engine.js";
import { runExternalAdapters } from "../adapters/runner.js";
import { getLanguageByExtension, getNativeLanguages, type NativeLanguageId } from "../engines/native/languages.js";
import { parseWithTreeSitter } from "../engines/native/loader.js";
import { loadNativeRules } from "../engines/native/rules.js";
import { runNativeTaint } from "../engines/native/taint.js";
